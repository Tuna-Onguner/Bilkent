def needleman_wunsch(pattern, text, match_score, mismatch_penalty, gap_penalty):
    """
    ...
    :return: A tuple containing the aligned pattern, aligned text, score, max overlap, cigar, and mdz respectively
    """
    """
    REFERENCES:
